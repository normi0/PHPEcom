...
if (isset($_POST['add_category_btn'])) {
  ...
  if (isset($_POST['delete_category_btn'])) {
    ...
    if ($name != "" && $Slug != "" && $description != "" && $original_price != "" && $selling_price != "" && $qty != "") {
    ...
    VALUES ('$category_id','$name','$Slug','$small_description','$description','$original_price','$selling_price','$qty','$meta_title','$meta_description','$meta_keywords','$Status','$trending','$filename')";
      ...
      if ($product_query_run) {
        move_uploaded_file($_FILES['image']['tmp_name'], $path . '/' . $filename);
        redirect("add-product.php", "Product Added Seccessflly");
      } else {
        redirect("add-product.php", "Somthing Went Wrong");
      }
    } else {
      redirect("add-product.php", "Thouse fileds are mandatory");
    }
    ...
    if ($new_image != "") {
     ...
     ,meta_title='$meta_title',meta_description='$meta_description',meta_keywords='$meta_keywords',Status='$Status',trending='$trending',image ='$update_filename' WHERE id ='$product_id' ";
       ...
       if ($update_product_query_run) {
        ...
        redirect("edit-product.php?id=$product_id", "Product Updated Seccessfully");
      } else {
