        ...
        <div class="col-md-12">
            ...
            if (isset($_GET['id'])) {
                ...
                if (mysqli_num_rows($product) > 0) {
                            ...
                            <form action="code.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" required name="original_price" value="<?= $data['original_price']; ?>"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" required name="selling_price" value="<?= $data['selling_price']; ?>"
                                            placeholder="Seling Price" class="form-control mb-2">
                                    </div>
                                    <div class="col-md-12">
                    ...
                    echo "Product not Found For Giveng Id";
                }
